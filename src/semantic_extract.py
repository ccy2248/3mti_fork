...
# Image input
IMAGE_DIR = '/tmp/3mti_data/val/vv'
# Prompt text output
OUTPUT_FILE_PATH = '/data/home/scxk346/run/workspace/3mti/data/sen12mscr/val_vv_prompt.txt'

PRETRAINED_MODEL_PATH = '/data/home/scxk346/run/workspace/3mti/trained_model/ram_swin_large_14m.pth'
DAPE_CKPT_PATH = '/data/home/scxk346/run/workspace/3mti/trained_model/DAPE.pth'
