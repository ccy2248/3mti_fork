...
os.environ.setdefault("SD_TURBO_PATH", "/data/run01/scxk346/workspace/3mti/models/sd-turbo")
...
if __name__ == "__main__":
    ...
    prompt_dict = {}
    if os.path.exists("/data/home/scxk346/run/workspace/3mti/data/C-CUHK/nir/CUHK-CR2/test_cloud_prompt.txt"):
        with open("/data/home/scxk346/run/workspace/3mti/data/C-CUHK/nir/CUHK-CR2/test_cloud_prompt.txt", "r") as f:
            for line in f:
                if ":" in line:
