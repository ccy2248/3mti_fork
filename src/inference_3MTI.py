...
os.environ.setdefault("SD_TURBO_PATH", "/home/user/Workspace/3mti/models/sd-turbo")
...
if __name__ == "__main__":
    ...
    prompt_dict = {}
    if os.path.exists("/home/user/Workspace/3mti/picture/prompt.txt"):
        with open("/home/user/Workspace/3mti/picture/prompt.txt", "r") as f:
            for line in f:
                if ":" in line:
